...
motor_load = "/home/gsanchez/fun/thesis/code/datalogs/20141109.csv"
...
ub = {"x" : np.array([np.inf, np.inf, np.inf, np.inf, np.inf, np.inf, np.inf, np.inf, np.inf, np.inf, np.inf, np.inf])}
lb = {"x" : np.array([-np.inf, -np.inf, -np.inf, -np.inf, -np.inf, -np.inf, -np.inf, -np.inf, -np.inf, 0, 0, -np.inf])}
...
estimator, sol, varVal, parVal, lbx, ubx = tools.nmhe_ltv(f_casadi, h_casadi, u_0, y_0,
                                                          ...
                                                          ltv_guess=None, guess=None, returnSolver=True, lb=lb, ub=ub)
